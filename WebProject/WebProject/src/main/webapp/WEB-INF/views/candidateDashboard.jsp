...
<head>
                ...
                <div class="row " >
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
                                <form class="navbar-search pull-left input-append" action="searchJobs">
                                <ul><select name="searchByOption">
  ...
  <option value="salary">Salary</option>
                        ...
                        <input type="text" class="span3" name="searchText">
            ...
            <c:forEach var="job" items="${jobs}">
                <tr>
                    ...
                    <td>${job.industry}</td>
                    <td> <form action="sendToEmployer"> <input type="hidden" value="${job.postedBy}" name="company" ><input type="hidden" value="${job.jobID}" name="jobID" ><input type="submit" value="apply"></form></td>
