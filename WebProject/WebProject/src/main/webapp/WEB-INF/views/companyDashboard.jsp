                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        ...
                        <ul class="nav pull-right">
                            <<!-- li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Update Profile
                                <b class="caret"></b></a>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a href="ui-button-icon.html"><i class="menu-icon icon-bold"></i> Add a Job </a></li>
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a class="collapsed" data-toggle="collapse" href="#togglePages"><i class="menu-icon icon-cog">
                                    ...
                                    <ul id="togglePages" class="collapse unstyled">
                                        <li><a href="other-user-profile.html"><i class="icon-inbox"></i>View </a></li>
                                    </ul>
                                </li>
