...
<body>
	...
	<div class="wrapper">
		<div class="container">
            ...
            <c:forEach var="job" items="${applicants}">
                <tr>
                    <td>${job.sender}</td>
                    <td>${job.receiver}</td>
                    <td>${job.status}</td>
                    <td>${job.person.firstName}</td>
                   <td> <form action="viewCandidateProfile"><input type="hidden" value="${job.requestId}" name="jobID" ><input type="submit" value="View Profile"></form></td>
                   
                     <td> <form action="notifyCandidate"><input type="hidden" value="${job.requestId}" name="jobID" ><button type="submit" value="Select">Select</button></form></td>
                </tr>
            </c:forEach>
        </table>
