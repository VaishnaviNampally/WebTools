    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Start Hiring</a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>Start Hiring</h1>
                <hr>
                <p>Start Hiring can help you build better career! Just sign-up and start going, no strings attached!</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">Create an account and login !</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Upload Resume</h3>
                        <p class="text-muted">Upload Resume , Cover Letters !</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Search Jobs</h3>
                        <p class="text-muted">Search jobs in your field !</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Get Hired</h3>
                        <p class="text-muted">Be the next big thing for companies!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row no-gutter">
                <div class="col-lg-4 col-sm-6">
                    <a href="registerCandidate" class="portfolio-box">
               ...
               <div class="col-lg-4 col-sm-6">
                    <a href="registerCompany" class="portfolio-box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="primary">
                    <p>Ready to start working with us? That's great! Give us a call or send us an email and we will get back to you as soon as possible!</p>
                </div>
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:your-email@your-domain.com">feedback@starthiring.com</a></p>
                </div>
            </div>
        </div>
    </section>
