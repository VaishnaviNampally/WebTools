...
<form:form action="addExperience" commandName="experience" method="post">
  <fieldset>
    <div id="legend">
      <legend class=""><h2>Add Experience</h2></legend>
    </div>
	<div><h3>Add</h3></div>
    <div class='form-group'>
		...
		<label class='control-label col-sm-2'>Role</label>
			<div class='col-sm-4'>
			<form:input path="role" size="30" class='form-control'/><form:errors path="role"></form:errors>
	 ...
	 <div class='form-group'>
		<label class='control-label col-sm-2'>Description</label>
			<div class='col-sm-4'>
			<form:input path="description" size="30" class='form-control' /><form:errors path="description"></form:errors>
			<!--  	<input type='text' class='form-control' name='userName' />-->
			</div></div>
			<div class='form-group  input-group date' data-provide='datepicker'>
		<label class='control-label col-sm-2'>Start Date</label>
			<div class='col-sm-4'>
			<form:input path="startDate" size="30" class='form-control'/><form:errors path="startDate"></form:errors>
	 ...
	 <div class='form-group input-group date' data-provide='datepicker'>
		<label class='control-label col-sm-2'>End Date</label>
			<div class='col-sm-4'>
			<form:input path="endDate" size="30" class='form-control' /><form:errors path="endDate"></form:errors>
			<span class='form-group input-group-addon add-on '> 
							<button type="button" class="btn btn-info">
						  		<span class='glyphicon glyphicon-calendar'></span>
							</button></span>
