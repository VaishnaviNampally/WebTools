...
<head>
    ...
    <body >
        ...
        <div class="wrapper">
            ...
            <c:forEach var="job" items="${comp}">
                <tr>
                    <td>${job.userID}</td>
                    <td>${job.companyName}</td>
                    
                  <!--  <td> <form action="sendToEmployer"> <input type="submit" value="apply"></form></td> 
                    <td><form action="deleteCompany" method="POST"><input type="hidden" value="${job.userID}" name="userID"><input type="submit" value="Delete Company"></form></td>-->
                </tr>
            </c:forEach>
        </table>
